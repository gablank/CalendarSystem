...
class ClientHandler extends Network {
    ...
    protected void handleMessage(JSONObject message) throws IOException {
		...
		// System.out.println("Recieved message to do something while not logged in, ignoring it. message: "
		// + message.toString());
		// return;
		// }
		//
		...
		// "The username and password combination was wrong!");
		// System.out.println("Someone tried logging in as " + username +
		...
		//
		// }else{
		// System.out.println("a login message did not have the required fields: "
		// + message.toString());
		// }
		//
		// break;
		...
		// appointment = new Appointment(owner, title, description, startDate,
		// endDate, meetingRoom);
		//
		// }else{
		// appointment = new Appointment(owner, title, description, startDate,
		...
		//
		// }else{
		// System.out.println("an appointment message did not have the required fields: "
		// + message.toString());
		// }
		//
		// break;
		//
		// case "meetingRoom":
		// if ((action == "new" || action == "change") && message.has("id") &&
		...
		//
		// } else {
		// System.out.println("a meetingRoom message did not have the required fields: "
		// + message.toString());
		// }
		//
		//
